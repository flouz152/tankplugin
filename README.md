...
Always invoke the included wrapper scripts rather than a locally installed Gradle. The build enforces Gradle 4.9 (ForgeGradle 3's
supported version) and will download the missing `gradle/wrapper/gradle-wrapper.jar` automatically on first use.
